...
android {
    ...
    buildFeatures {
        compose = true
        buildConfig = true
        aidl = true // 启用 AIDL 编译，用于 Shizuku UserService
    }
...
dependencies {
    ...
    // Shizuku（debug only）：免 Root 读取已安装 App 的 Cookie
    debugImplementation("dev.rikka.shizuku:api:13.1.5")
    debugImplementation("dev.rikka.shizuku:provider:13.1.5")
